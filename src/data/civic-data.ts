...
export const CIVIC_FLOWS: CivicFlow[] = [
  {
    ...
    description:
      'Step-by-step guide to registering on the electoral roll for the first time using Form 6.',
    eligibilityNote:
      'You must be an Indian citizen, 18 years or older on the qualifying date (January 1 of the year of revision), and ordinarily resident at the address you are registering with.',
    steps: [
      {
        id: 'step-1',
    ...
    documents: [
      {
        ...
        examples: [
          ...
          'Birth certificate',
          'Class 10 school leaving certificate / mark sheet',
          'Passport',
          'PAN card',
        ],
      },
      {
        ...
        examples: [
          'Aadhaar card (if it shows current address)',
          'Electricity / water / gas bill (within last 3 months)',
    ...
    nextActions: [
      {
        label: 'Start Form 6 Registration',
...

  {
    ...
    description:
      'Verify whether your name is on the electoral roll before election day.',
    steps: [
      {
        id: 'step-1',
...

  {
    ...
    description:
      'Fix errors in your name, date of birth, photo, or other details on the electoral roll using Form 8.',
    steps: [
      {
        id: 'step-1',
    ...
    documents: [
      ...
      },
      {
        ...
        examples: [
          ...
          'PAN card',
          'Passport',
          'Class 10 certificate (for name or DOB correction)',
          'Birth certificate',
        ],
      },
    ],
    nextActions: [
      {
        label: 'Submit Form 8 for Correction',
        href: 'https://voters.eci.gov.in/',
        type: 'external',
      },
    ],
...

  {
    ...
    description:
      'Update your registered address when you move to a new home using Form 8.',
    steps: [
      {
        id: 'step-1',
    ...
    documents: [
      ...
      },
      {
        ...
        examples: [
          'Aadhaar card (if updated to new address)',
          'Electricity / water / gas bill — dated within last 3 months',
    ...
    nextActions: [
      {
        label: 'Submit Form 8 for Address Change',
        href: 'https://voters.eci.gov.in/',
        type: 'external',
      },
    ],
...

  {
    ...
    description:
      'Locate your assigned polling booth and understand what to bring on election day.',
    steps: [
      {
        id: 'step-1',
