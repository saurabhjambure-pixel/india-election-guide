...
*   **Deferred Execution:** The application assumes the role of a *guide*. It explicitly does not collect application forms or upload documents to the government on the user's behalf.
